...
#### 3.1 ตาราง Timeline ธุรกรรมการเงิน (บังคับ — markdown table format)
...
- **บังคับ: ขึ้นบรรทัดใหม่ในโหนด ใช้ `<br/>` เท่านั้น ห้ามใช้ `\\n`** (เพราะ `\\n` จะแสดงเป็นตัวอักษรดิบในรูป) เช่น `A["จ่ายมัดจำ<br/>฿10,000<br/>(19/04/2566)"]`
- ขนาด flowchart พอเหมาะ — โหนดละ ≤6 คำ, ไม่เกิน 10 โหนดทั้งหมด (เพื่อให้ใส่ในหน้า A4 พอดี)
