...
### 3. Timeline ธุรกรรมการเงิน (text-based — แสดงได้ทุก format)

**บังคับใส่ถ้ามีธุรกรรม ≥ 3 รายการที่ระบุวันที่ได้** ถ้าน้อยกว่านั้น **ข้ามหัวข้อนี้ไปเลย** ห้ามเขียน "ไม่มีข้อมูล"

ใช้รูปแบบ text-art นี้ (เป็นภาพประกอบหลัก — render ได้ทั้ง UI / PDF / DOCX):
```
...
### 4. Flowchart (Mermaid) — เฉพาะกรณีมี branching logic

**ใส่เฉพาะถ้าธุรกรรมมีเงื่อนไข/แตกสาขา** (เช่น "ถ้าชำระตรงเวลา → A, ถ้าไม่ → B, ถ้า B แล้วผิดนัดอีก → C")
**ถ้าธุรกรรมเป็นเส้นตรงไม่มีสาขา — ข้ามหัวข้อนี้ไปเลย** (Timeline ด้านบนเพียงพอแล้ว)
...
❌ ห้ามเขียนเป็นย่อหน้ายาว — ทุกอย่างต้องอยู่ใน 4 ส่วน: สรุปย่อ + ตาราง + Timeline + Flowchart (เฉพาะที่เหมาะสม)
❌ ห้ามตีความกฎหมาย — เน้นเฉพาะ "เงินไหลอย่างไร"
❌ **ห้ามใส่ Flowchart Mermaid ถ้าไม่มี branching จริง** — ข้ามไปเลย Timeline พอแล้ว
❌ **ห้ามใส่ Timeline ถ้ามีธุรกรรมน้อยกว่า 3 รายการ** — ข้ามไปเลย ตารางพอแล้ว
